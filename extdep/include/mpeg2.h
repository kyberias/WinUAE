...
typedef struct mpeg2_convert_init_s {
	...
	void(__cdecl * start) (void * id, const mpeg2_fbuf_t * fbuf,
            const mpeg2_picture_t * picture, const mpeg2_gop_t * gop);
	void(__cdecl * copy) (void * id, uint8_t * const * src, unsigned int v_offset);
...
typedef int __cdecl mpeg2_convert_t(int stage, void * id,
                 const mpeg2_sequence_t * sequence, int stride,
                 uint32_t accel, void * arg,
                 mpeg2_convert_init_t * result);
int __cdecl mpeg2_convert(mpeg2dec_t * mpeg2dec, mpeg2_convert_t convert, void * arg);
int __cdecl mpeg2_stride(mpeg2dec_t * mpeg2dec, int stride);
void __cdecl mpeg2_set_buf(mpeg2dec_t * mpeg2dec, uint8_t * buf[3], void * id);
void __cdecl mpeg2_custom_fbuf(mpeg2dec_t * mpeg2dec, int custom_fbuf);
...
int __cdecl mpeg2_getpos(mpeg2dec_t * mpeg2dec);
void __cdecl mpeg2_skip(mpeg2dec_t * mpeg2dec, int skip);
void __cdecl mpeg2_slice_region(mpeg2dec_t * mpeg2dec, int start, int end);
void __cdecl mpeg2_tag_picture(mpeg2dec_t * mpeg2dec, uint32_t tag, uint32_t tag2);
int __cdecl mpeg2_guess_aspect(const mpeg2_sequence_t * sequence, unsigned int * pixel_width, unsigned int * pixel_height);
void * __cdecl mpeg2_malloc(size_t size, mpeg2_alloc_t reason);
void __cdecl mpeg2_free(void * buf);

#ifdef __cplusplus
extern "C" {
#endif 

uint32_t __cdecl mpeg2_set_accel(uint32_t accel);
uint32_t __cdecl mpeg2_accel(uint32_t accel);
mpeg2dec_t * __cdecl mpeg2_init(void);
const mpeg2_info_t * __cdecl mpeg2_info(mpeg2dec_t * mpeg2dec);
void __cdecl mpeg2_close(mpeg2dec_t * mpeg2dec);
void __cdecl mpeg2_buffer(mpeg2dec_t * mpeg2dec, uint8_t * start, uint8_t * end);
mpeg2_state_t __cdecl mpeg2_parse(mpeg2dec_t * mpeg2dec);
void __cdecl mpeg2_reset(mpeg2dec_t * mpeg2dec, int full_reset);
void __cdecl mpeg2_set_rtStart(mpeg2dec_t *mpeg2dec, int64_t rtStart);
