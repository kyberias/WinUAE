...
__declspec(dllimport) DWORD _cdecl GetASPI32SupportInfo( void );
__declspec(dllimport) DWORD _cdecl SendASPI32Command( LPSRB );
__declspec(dllimport) BOOL _cdecl GetASPI32Buffer( PASPI32BUFF );
__declspec(dllimport) BOOL _cdecl FreeASPI32Buffer( PASPI32BUFF );
__declspec(dllimport) BOOL _cdecl TranslateASPI32Address( PDWORD, PDWORD );
