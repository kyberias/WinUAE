...
static int NOINLINE linetoscr_16_stretch1_aga_spr_genlock(int spix, int dpix, int dpix_end)
{
    ...
    if (bplham) {
        while (dpix < dpix_end) {
            ...
            uae_u32 out_val1 = out_val;
            uae_u32 out_val2 = out_val;
            uae_u32 spix_val1 = spix_val;
            uae_u32 spix_val2 = spix_val;
            if (spritepixels[dpix + 0].data) {
                sprcol = render_sprites (dpix + 0, 0, sprpix_val, 1);
                if (sprcol) {
                    out_val1 = colors_for_drawing.acolors[sprcol];
            ...
            genlock_buf[dpix] = spix_val1;
            buf[dpix++] = out_val1;
            genlock_buf[dpix] = spix_val2;
            buf[dpix++] = out_val2;
            }
        }
    } else if (bpldualpf) {
...
static int NOINLINE linetoscr_16_stretch2_aga_spr_genlock(int spix, int dpix, int dpix_end)
{
    ...
    if (bplham) {
        while (dpix < dpix_end) {
            ...
            uae_u32 spix_val1 = spix_val;
            uae_u32 spix_val2 = spix_val;
            uae_u32 spix_val3 = spix_val;
            uae_u32 spix_val4 = spix_val;
            if (spritepixels[dpix + 0].data) {
                sprcol = render_sprites (dpix + 0, 0, sprpix_val, 1);
                if (sprcol) {
                    out_val1 = colors_for_drawing.acolors[sprcol];
            ...
            genlock_buf[dpix] = spix_val2;
            buf[dpix++] = out_val2;
            genlock_buf[dpix] = spix_val3;
            buf[dpix++] = out_val3;
            genlock_buf[dpix] = spix_val4;
            buf[dpix++] = out_val4;
            }
        }
    } else if (bpldualpf) {
